...
export default function Footer({}: Props) {
  ...
  return (
    <div className='bg-blue-800/30 w-screen px-5 pt-6 pb-4 sm:px-24 sm:py-5 md:pt-10 relative bottom-0 text-gray-700 text-sm sm:text-md'>
        ...
        <h2 className='mb-2'>{language === "hun" ? "Elérhetőség:" : "Contact: "} <span className={mystyle}>info@vivaldialapitvany.hu</span>
