...
export default function LanguageSwitch({}: Props) {
  ...
  const styles = "bg-gradient-to-br from-green-800/80 to-green-800/30 rounded-full px-1 shadow-lg border border-green-700";
  const stylesselected = "bg-gradient-to-br from-green-800/40 to-green-800/10 rounded-full px-1 shadow-lg border border-green-700";
  const engBio = () => {
    setLanguage('eng');
  }
